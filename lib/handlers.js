...
exports.newsletter = (req, res) => {
    res.render("newsletter", { _csrf: "Here lies CSRF token" });
}
...
exports.vacationPhotoContest = (req, res) => {
    res.render("contest/vacation-photo", { _csrf: "Here lies CSRF token", year: req.params.year, month: req.params.month });
}
